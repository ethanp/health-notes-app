...
class ConditionsScreen extends ConsumerWidget {
  ...
  Widget conditionsList(BuildContext context, WidgetRef ref, List<Condition> conditions) {
      ...
      slivers: [
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) => conditionCard(context, ref, activeConditions[index]),
        ...
        if (resolvedConditions.isNotEmpty) ...[
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) => conditionCard(context, ref, resolvedConditions[index]),
  ...
  Widget conditionCard(BuildContext context, WidgetRef ref, Condition condition) {
    return Padding(
  ...
  void navigateToDetail(BuildContext context, Condition condition) {
    Navigator.of(context).push(
      CupertinoPageRoute(
        builder: (context) => ConditionDetailScreen(conditionId: condition.id),
      ),
    );
  }
